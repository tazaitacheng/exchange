...
@interface HJChannelView ()
{
    CGPoint _startPoint;
    NSArray* _reorderTitleNameArray;
}
...
- (void)longPressGestureStateEndedWithGesture:(UILongPressGestureRecognizer *)longPressGestureRecognizer button:(UIButton *)button
{
    [self buttonOrderChangedAnimationWithButton:nil completion:^{
        [UIView animateWithDuration:0.3 animations:^{
            ...
            HJChannelViewModel *channelViewModel = [[HJChannelViewModel alloc] initWithTotalArray:self.totalArray];
...
- (void)itemPressed:(UIButton *)button
{
    ...
    [UIView animateWithDuration:0.1 animations:^{
        ...
        [UIView animateWithDuration:0.1 animations:^{
            ...
            [self sendNotificationOfSelectedChannelChanged:self.selectedArray];
            [NSUD setObject:self.selectedArray forKey:SELECTED_CHANNEL_NAMES];
            HJChannelViewModel *channelViewModel = [[HJChannelViewModel alloc] initWithTotalArray:self.selectedTotalArray];
...
{
    HJChannelViewModel *channelView = [NSKeyedUnarchiver unarchiveObjectWithFile:CHANNEL_FILE_PATH];

...
{
    _popView = [[HJPopView alloc] initWithTitleNames:self.totalItemTitles];
...
- (void)setCurrentIndex:(NSInteger)currentIndex
{
    ...
    CGFloat offsetX = button.centerX - _navigationTabBarWidth * 0.5;
